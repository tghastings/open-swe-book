...
- 📄 **INVEST in Good Stories** — Agile Alliance glossary,
  ...
  The canonical short definition of Independent/Negotiable/Valuable/Estimable/Small/Testable
 , with links to Bill Wake's original 2003 article.
...
- 📄 **Orlena Gotel & Anthony Finkelstein — "An Analysis of the Requirements Traceability
  Problem" (ICRE 1994)** — [doi.org](https://doi.org/10.1109/ICRE.1994.292398). The classic
  statement of why traces decay and what forward/backward traceability must answer (used in
  §3.4.4). Publisher page; author preprints are widely indexed.
...
- 📘 **Ryan Singer — *Shape Up*, ch. "Set Boundaries" (Basecamp, 2019)** —
  [basecamp.com/shapeup](https://basecamp.com/shapeup/1.2-chapter-03). Problem-framing, the
  *baseline*, and avoiding "grab-bag" requests (used in §3.3.2). Free to read online.
